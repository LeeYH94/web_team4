...
SELECT * FROM GUEST WHERE ID= 'abcd';

SELECT 'abcd' FROM GUEST WHERE ID = 'abcd' AND PHONE_NUMBER = '01099194461';

SELECT A.PLANE_INFORMATION, B.HOTEL_INFORMATION FROM GUEST G 
